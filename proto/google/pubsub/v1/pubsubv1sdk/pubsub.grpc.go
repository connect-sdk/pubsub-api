...
import (
	...
	pubsubv1connect "github.com/connect-sdk/pubsub-api/proto/google/pubsub/v1/pubsubv1connect"
)

var _ pubsubv1.PubsubServiceClient = &PubsubServiceConn{}

// PubsubServiceConn is a client for the google.pubsub.v1.PubsubService service.
type PubsubServiceConn struct {
...
func NewPubsubServiceClient(uri string, options ...PubsubServiceClientOption) pubsubv1.PubsubServiceClient {
	...
	return &PubsubServiceConn{client: client}
}

// PushPubsubMessage implements google.pubsub.v1.PubsubServiceClient.
func (x *PubsubServiceConn) PushPubsubMessage(ctx context.Context, m *pubsubv1.PubsubMessage) error {
...
var _ pubsubv1connect.PubsubServiceHandler = &PubsubServiceController{}

// PubsubServiceController represents an instance of google.pubsub.v1.PubsubServiceHandler handler.
type PubsubServiceController struct {
...
func (x *PubsubServiceController) Mount(r chi.Router) {
	var interceptors []connect.Interceptor
	// prepare the interceptors
	interceptors = append(interceptors, interceptor.WithTracer())
	interceptors = append(interceptors, interceptor.WithLogger())
...
func (x *PubsubServiceController) PushPubsubMessage(ctx context.Context, r *connect.Request[pubsubv1.PushPubsubMessageRequest]) (*connect.Response[pubsubv1.PushPubsubMessageResponse], error) {
