...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/connect-sdk/pubsub-api/proto/google/pubsub/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PubsubServiceName = "google.pubsub.v1.PubsubService"
)
...
const (
	...
	PubsubServicePushPubsubMessageProcedure = "/google.pubsub.v1.PubsubService/PushPubsubMessage"
)
...
// NewPubsubServiceClient constructs a client for the google.pubsub.v1.PubsubService service. By
...
// PushPubsubMessage calls google.pubsub.v1.PubsubService.PushPubsubMessage.
...
// PubsubServiceHandler is an implementation of the google.pubsub.v1.PubsubService service.
...
func NewPubsubServiceHandler(svc PubsubServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/google.pubsub.v1.PubsubService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPubsubServiceHandler) PushPubsubMessage(context.Context, *connect.Request[v1.PushPubsubMessageRequest]) (*connect.Response[v1.PushPubsubMessageResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("google.pubsub.v1.PubsubService.PushPubsubMessage is not implemented"))
}
